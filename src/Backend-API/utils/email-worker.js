...
const sendConfirmationEmail = async (user, confirmationToken) => {
  try {
    const mailOptions = {
      ...
      Click this link to confirm your account: ${process.env.CORS_ORIGIN}/confirm/${confirmationToken}
...
const sendPasswordResetEmail = async (user, resetToken) => {
  ...
  try {
    const mailOptions = {
      ...
      html: `Hello ${user.name},
      Please click this link to reset your password: ${process.env.CORS_ORIGIN}/reset-password/${resetToken}
      The link will expire in 1 hour.
